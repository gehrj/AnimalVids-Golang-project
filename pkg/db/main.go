...
// this basically allows us to programatically create the structs we need from our db . instead of writing out each struct this will build it for us. to use this I added script in make file
// to run this in command line write make build_db
